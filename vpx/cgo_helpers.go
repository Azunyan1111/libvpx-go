...
func (x *CodecEncCfg) PassRef() (*C.vpx_codec_enc_cfg_t, *cgoAllocMap) {
	if x == nil {
		...
		// Sync Go struct values to C struct
		x.ref37e25db9.g_usage = (C.uint)(x.GUsage)
		x.ref37e25db9.g_threads = (C.uint)(x.GThreads)
		x.ref37e25db9.g_profile = (C.uint)(x.GProfile)
		x.ref37e25db9.g_w = (C.uint)(x.GW)
		x.ref37e25db9.g_h = (C.uint)(x.GH)
		x.ref37e25db9.g_bit_depth = (C.vpx_bit_depth_t)(x.GBitDepth)
		x.ref37e25db9.g_input_bit_depth = (C.uint)(x.GInputBitDepth)
		x.ref37e25db9.g_timebase, _ = x.GTimebase.PassValue()
		x.ref37e25db9.g_error_resilient = (C.vpx_codec_er_flags_t)(x.GErrorResilient)
		x.ref37e25db9.g_pass = (C.enum_vpx_enc_pass)(x.GPass)
		x.ref37e25db9.g_lag_in_frames = (C.uint)(x.GLagInFrames)
		x.ref37e25db9.rc_dropframe_thresh = (C.uint)(x.RcDropframeThresh)
		x.ref37e25db9.rc_resize_allowed = (C.uint)(x.RcResizeAllowed)
		x.ref37e25db9.rc_scaled_width = (C.uint)(x.RcScaledWidth)
		x.ref37e25db9.rc_scaled_height = (C.uint)(x.RcScaledHeight)
		x.ref37e25db9.rc_resize_up_thresh = (C.uint)(x.RcResizeUpThresh)
		x.ref37e25db9.rc_resize_down_thresh = (C.uint)(x.RcResizeDownThresh)
		x.ref37e25db9.rc_end_usage = (C.enum_vpx_rc_mode)(x.RcEndUsage)
		x.ref37e25db9.rc_twopass_stats_in, _ = x.RcTwopassStatsIn.PassValue()
		x.ref37e25db9.rc_firstpass_mb_stats_in, _ = x.RcFirstpassMbStatsIn.PassValue()
		x.ref37e25db9.rc_target_bitrate = (C.uint)(x.RcTargetBitrate)
		x.ref37e25db9.rc_min_quantizer = (C.uint)(x.RcMinQuantizer)
		x.ref37e25db9.rc_max_quantizer = (C.uint)(x.RcMaxQuantizer)
		x.ref37e25db9.rc_undershoot_pct = (C.uint)(x.RcUndershootPct)
		x.ref37e25db9.rc_overshoot_pct = (C.uint)(x.RcOvershootPct)
		x.ref37e25db9.rc_buf_sz = (C.uint)(x.RcBufSz)
		x.ref37e25db9.rc_buf_initial_sz = (C.uint)(x.RcBufInitialSz)
		x.ref37e25db9.rc_buf_optimal_sz = (C.uint)(x.RcBufOptimalSz)
		x.ref37e25db9.rc_2pass_vbr_bias_pct = (C.uint)(x.Rc2passVbrBiasPct)
		x.ref37e25db9.rc_2pass_vbr_minsection_pct = (C.uint)(x.Rc2passVbrMinsectionPct)
		x.ref37e25db9.rc_2pass_vbr_maxsection_pct = (C.uint)(x.Rc2passVbrMaxsectionPct)
		x.ref37e25db9.kf_mode = (C.enum_vpx_kf_mode)(x.KfMode)
		x.ref37e25db9.kf_min_dist = (C.uint)(x.KfMinDist)
		x.ref37e25db9.kf_max_dist = (C.uint)(x.KfMaxDist)
		x.ref37e25db9.ss_number_layers = (C.uint)(x.SsNumberLayers)
		x.ref37e25db9.ss_enable_auto_alt_ref = *(*[5]C.int)(unsafe.Pointer(&x.SsEnableAutoAltRef))
		x.ref37e25db9.ss_target_bitrate = *(*[5]C.uint)(unsafe.Pointer(&x.SsTargetBitrate))
		x.ref37e25db9.ts_number_layers = (C.uint)(x.TsNumberLayers)
		x.ref37e25db9.ts_target_bitrate = *(*[5]C.uint)(unsafe.Pointer(&x.TsTargetBitrate))
		x.ref37e25db9.ts_rate_decimator = *(*[5]C.uint)(unsafe.Pointer(&x.TsRateDecimator))
		x.ref37e25db9.ts_periodicity = (C.uint)(x.TsPeriodicity)
		x.ref37e25db9.ts_layer_id = *(*[16]C.uint)(unsafe.Pointer(&x.TsLayerID))
		x.ref37e25db9.layer_target_bitrate = *(*[12]C.uint)(unsafe.Pointer(&x.LayerTargetBitrate))
		x.ref37e25db9.temporal_layering_mode = (C.int)(x.TemporalLayeringMode)
